...
gm_auth_configure(path = "credentials_v2.json")
...
this_year <- SantasLittleHelper(presents,"guest",
                   conflictCols = c("partner","presents2018","presents2019","presents2020"))
...
P.S. Santa apologises for the slow delivery of the list - there were some technical issues that could have been resolved much faster if names had simply been drawn from a hat. But he preferred to code his way out of the issue, which took some time..."))
