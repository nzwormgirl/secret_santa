...
http://www.r-bloggers.com/merry-christmas-5/
...
png('Merry Christmas.png',width=14,height=15,units='cm',pointsize=10,res=300)
...
points(0,9.75,pch=24,col="gold",bg="gold",cex=2)
points(0,9.75,pch=25,col="gold",bg="gold",cex=2)
